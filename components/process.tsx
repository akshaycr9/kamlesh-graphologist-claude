...
const steps = [
  {
    ...
    description:
      "Write 3–5 natural sentences in your everyday handwriting on unlined paper. A photo or scan is all you need — no special tools or preparation required.",
        ...
        <div ref={stepsRef} className="reveal">
          ...
          <div className="hidden md:block">
            ...
            <div className="relative">
              <div className="absolute top-9 left-0 right-0 h-px bg-gradient-to-r from-transparent via-gold/40 to-transparent" aria-hidden="true" />
              <div className="grid grid-cols-4 gap-6 relative">
                {steps.map((step, i) => (
                  <DesktopStep key={step.number} step={step} isLast={i === steps.length - 1} />
                ))}
              </div>
            </div>
          </div>
