    ...
    >
        ...
        <div className="grid md:grid-cols-3 gap-12 md:gap-10">
          ...
          <div>
            ...
            <address className="not-italic space-y-3 font-body text-sm text-parchment-300/75">
              <p>
                <span className="text-parchment-200/50 text-xs uppercase tracking-wider block mb-0.5">Email</span>
                <a
              ...
              <p>
                <span className="text-parchment-200/50 text-xs uppercase tracking-wider block mb-0.5">WhatsApp</span>
                <a
                  href="https://wa.me/919876543210"
                  target="_blank"
                  rel="noopener noreferrer"
              ...
              <p>
                <span className="text-parchment-200/50 text-xs uppercase tracking-wider block mb-0.5">Availability</span>
      ...
      <div className="border-t border-parchment-100/10">
        <div className="container py-5 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-parchment-300/50 font-body">
          <p>
            &copy; {currentYear} Kamlesh Patel. All rights reserved.
          </p>
